...
@Component({
  selector: 'app-abnormal-weight-list',
  templateUrl: './abnormal-weight-list.component.html',
  styleUrls: ['./abnormal-weight-list.component.scss', '../../../style.scss'],
  providers: [PackageService, OrderInfoService, ShippingMethodService, WarehouseService, JwtService]
})
export class AbnormalWeightListComponent extends AuthorityComponent implements OnInit {
  @Input()
  ...
  selectedTimeTypes: string='PreTime';
  ...
  suppprtTimeTypes: CommonOptionModel[] = [{ text: '配货时间', value: 'PreTime' }, { text: '发货时间', value: 'SendTime' }];
  ...
  loadData(pageNumber: number = 1) {
   if(this.seekmode==0) {
     ...
     this.packageSearchService.exceptionPackageList(this.selectedWarehouseId,
       selectServiceArrayIds,this.selectwarehouseShippingMerchant,this.selectedTimeTypes,
       this.selectedTimeValueType, this.timeSearchStart, this.timeSearchEnd, pageNumber, this.pageSize).subscribe(data => {
       ...
       this.packageSearchService.SrceenPackageList(this.selectedWarehouseId,
       this.searchType,this.searchText,pageNumber, this.pageSize).subscribe(data => {
       this.items = data.content.items;
       console.log(this.items);
       const pageInfo = data.content.pageInfo;
       this.pageSize = pageInfo.pageSize;
    ...
    // this.testItems = [{
    //   apiName: "YunTu",
    //   buyerName: "Mario Gómez García",
    //   countryCode: "Spain",
    //   createdTime: "2018-03-30T17:04:16.7915549+08:00",
    //   estimateShippingFee: 5.39,
    //   estimateWeight: 32,
    //   id: '429204205838389248',
    //   isTrackingNumberRequired: true,
    //   orderContent: null,
    //   orderId: 679,
    //   orderNumber: "405-1934474-8451555",
    //   packageItems: [{
    //     locationDesc: "良品",
    //     locationLable: null,
    //     locationType: "Good",
    ...
    //     skuId: 1548420,
    //   }],
    //   packageNumber: 'DGI3U00001',
    //   pickingNumber: null,
    //   shipShippingFee: null,
    //   shipWeight: null,
    //   shippedTime: null,
    //   shippingService: "西班牙专线平邮-云途",
    //   spPackageId: "YT1808503809100121",
    //   ssId: 0,
    //   status: "Allocated",
    //   statusDesc: "已配货",
    //   trackingNumber: "YT1808503809100121",
    // }]
  }
  ...
  onSelectTimeType(timeType: string) {
    this.selectedTimeTypes = timeType;
    this.loadData();
  }
