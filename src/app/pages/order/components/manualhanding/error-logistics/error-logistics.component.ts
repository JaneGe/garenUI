...
@Component({
  selector: 'app-error-logistics',
  templateUrl: './error-logistics.component.html',
  styleUrls: ['../../../public.scss','./error-logistics.component.scss'],
  providers: [OrderExceptionService]
})
export class ErrorLogisticsComponent extends AuthorityComponent implements OnInit {
  ...
  orderException: string = 'TrackingNumberFectchFailed';
