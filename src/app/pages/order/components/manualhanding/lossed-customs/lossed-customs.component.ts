...
@Component({
  selector: 'app-lossed-customs',
  templateUrl: './lossed-customs.component.html',
  styleUrls: ['../../../public.scss','./lossed-customs.component.scss'],
  providers: [OrderExceptionService]
})
export class LossedCustomsComponent  extends AuthorityComponent implements OnInit {

  constructor(  private orderExceptionService:OrderExceptionService,public activerouter: ActivatedRoute,public  router:Router) {
    super(activerouter,router);
  }

  orderException: string= 'DeclarationMissed';
