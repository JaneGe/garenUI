...
@Component({
  selector: 'app-failed-freight',
  templateUrl: './failed-freight.component.html',
  styleUrls: ['../../../public.scss','./failed-freight.component.scss'],
  providers: [OrderExceptionService]
})
export class FailedFreightComponent extends AuthorityComponent implements OnInit {
  ...
  orderException: string = 'CalcShippingFeeFaile';
