...
@Component({
  selector: 'app-lossed-info',
  templateUrl: './lossed-info.component.html',
  styleUrls: ['../../../public.scss','./lossed-info.component.scss'],
  providers: [OrderExceptionService]
})
export class LossedInfoComponent extends AuthorityComponent implements OnInit {
  ...
  orderException: string= 'AddressInvalid';
