...
@Component({
  selector: 'app-in-sku-modal',
  templateUrl: './in-sku-modal.component.html',
  styleUrls: ['./in-sku-modal.component.scss']
})
export class InSkuModalComponent extends RootComponent implements OnInit {

  public fileUploaderOptions: NgUploaderOptions = {
    url: `${environment.api_url}/api/v1/sku/skuImports`,
  };
