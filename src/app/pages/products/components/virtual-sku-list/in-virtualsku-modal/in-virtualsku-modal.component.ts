...
@Component({
  selector: 'app-in-virtualsku-modal',
  templateUrl: './in-virtualsku-modal.component.html',
  styleUrls: ['./in-virtualsku-modal.component.scss']
})
export class InVirtualSkuModalComponent extends RootComponent implements OnInit {
