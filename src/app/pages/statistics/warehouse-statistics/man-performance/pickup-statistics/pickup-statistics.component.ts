...
@Component({
  selector: 'app-pickup-statistics',
  templateUrl: './pickup-statistics.component.html',
  styleUrls: ['../../../orderStatistics/order-head/order-head.component.scss','../../../public.scss','./pickup-statistics.component.scss'],
  providers:[PackageDeliverService]
})
export class PickupStatisticsComponent extends AuthorityComponent implements OnInit {
  ...
  group:Array<any>=[{id:-1,text:'全部'},{id:1,text:'A'},{id:2,text:'B'},{id:3,text:'C'},{id:4,text:'D'}];
...
//高级筛选按钮
  ...
  initColumnarChart(name:string){
    ...
    Highcharts.chart('pickupColumncontainer',options);
  }
}
