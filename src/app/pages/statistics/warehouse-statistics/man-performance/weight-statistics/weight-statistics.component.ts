...
@Component({
  ...
  templateUrl: './weight-statistics.component.html',
  styleUrls: ['../../../orderStatistics/order-head/order-head.component.scss','../../../public.scss','./weight-statistics.component.scss'],
  providers:[PackageDeliverService]
})
export class WeightStatisticsComponent extends AuthorityComponent implements OnInit {
  ...
  initColumnarChart(name:string){
    ...
    Highcharts.chart('weightLinecontainer',options);
  }
}
