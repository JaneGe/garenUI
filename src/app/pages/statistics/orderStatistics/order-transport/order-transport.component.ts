...
@Component({
  ...
  styleUrls: ['../../public.scss','../order-head/order-head.component.scss','./order-transport.component.scss']
})
export class OrderTransportComponent extends AuthorityComponent  implements OnInit {
