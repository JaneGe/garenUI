...
export class OrderExceptionDetailModel {
  id: number;
  channelId: number;
  channelName: string;
  isLocked: boolean;
  ...
  siteTrackingNumber: string;
  siteShippingServiceName: string;
  shippingServiceCarrierCode: string;
  siteShippingServiceCarrierCode: string;
